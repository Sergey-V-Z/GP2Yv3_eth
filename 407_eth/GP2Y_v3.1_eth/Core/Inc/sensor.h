...
public:
	...
	void Init(TIM_TypeDef* tim, uint32_t triggerChannel, uint32_t echoChannel, GPIO_TypeDef* GPIO_pwr, uint16_t Pin_pwr, int ID, float soundSpeed = 343000.0f); // скорость звука указана в милиметрах/сек
